...
const deck = [...cards,...cards,...cards,...cards,...cards,...cards,...cards,...cards];
...
const cardDeck = [];//poter manipolare le carte per mostrarle all'inizio
//stampo le celle
...
function showCards(){
    ...
    for( let i = 0; i < deck.length; i++){
        ...
        setTimeout(function (){
            card.classList.remove(cardName);
        }, 10000);
    }
}
